    ...
    <div class="card card-outline card-navy rounded-0 shadow">
        <div class="card-header">
                 <?php
                    if ($status == 3) {
                ?>
                    <h4 class="card-title">Facture N#: <b><?= isset($code) ? $code : "" ?></b></h4>
                <?php
                    } else if ($status == 2) {
                ?>
                    <h4 class="card-title"> BL N#: <b><?= isset($code) ? $code : "" ?></b></h4>
                <?php
                }
                ?>
        ...
        <div class="card-body">
            <div class="container-fluid" id="printout">
                ...
                ?>
                <h2 class="text-navy text-right">Total: <b id="amount"><?= isset($amount) ? format_num($amount) : "0.00" ?> MAD</b></h2>
                <?php
                }
                ?>
    ...
    <div class="d-flex w-100">
        ...
        <div class="col-8 text-center">
            <div style="line-height:1em">
                ...
                ?>
                    <h3 class="text-center"><b>BL N#<?= isset($code) ? $code : '' ?></b></h3>
                <?php
                }
                ?>
            </div>
