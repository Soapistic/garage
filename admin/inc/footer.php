    ...
    <div class="daterangepicker ltr show-ranges opensright">
      <div class="ranges">
        <ul>
          ...
          <li data-range-key="Last 7 Days">7 jours précédents</li>
          <li data-range-key="Last 30 Days">30 jours précédents</li>
          <li data-range-key="This Month">Ce Mois</li>
          <li data-range-key="Last Month">Mois Précédent</li>
          <li data-range-key="Custom Range">Personnalisée</li>
        </ul>
      </div>
