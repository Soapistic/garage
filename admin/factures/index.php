			...
			<table class="table table-hover table-striped table-bordered">
				...
				<tbody>
					...
					$i = 1;
						...
						$qry = $conn->query("SELECT * FROM `transaction_list` where ( status = 3) order by unix_timestamp(date_updated) desc ");
						endif;
					...
					?>
						<tr>
							...
							<td align="center">
								<a class="btn btn-default bg-gradient-light btn-flat btn-sm" href="?page=factures/view_details&id=<?php echo $row['id'] ?>"><span class="fa fa-eye text-dark"></span> View</a>
							</td>
						</tr>
					<?php endwhile; ?>
				</tbody>
